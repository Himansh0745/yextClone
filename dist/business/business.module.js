...
const business_hour_entity_1 = require("./entities/business-hour.entity");
...
exports.BusinessModule = BusinessModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([business_entity_1.BusinessProfile, business_hour_entity_1.BusinessHour, location_entity_1.Location]),
        ],
