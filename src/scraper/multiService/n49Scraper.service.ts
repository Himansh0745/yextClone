  ...
  async scrapeN49(
    ...
    try {
      ...
      try {
        ...
        // console.log('⚠️ [N49] Suggestions/Results took too long or not found.', e);
        console.error('⚠️ [N49] Suggestions/Results took too long or not found.', (e as Error).message);
      }
      ...
      for (const link of links) {
        ...
        try {
          ...
          console.error(`❌ [N49] Error scraping deep link: ${link}`, (e as Error).message);
        } finally {
          await newPage.close();
        }
      }
